...
with (instance_create(0, 0, BattleAppliedEffect)){
    if (argument0.act_hp<argument0.act[Stats.HP]){
        ...
        ds_queue_enqueue(scheduled_actions, add_battle_individual_action(battle_individual_action_text, argument0.name+"'s health was restored!"));
    } else {
        ds_queue_enqueue(scheduled_actions, add_battle_individual_action(battle_individual_action_text, argument0.name+"is already healthy!"));
    }
